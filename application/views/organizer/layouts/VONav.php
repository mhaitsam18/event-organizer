    ...
    <div class="scrollbar-inner">
        <div class="sidenav-header  align-items-center">
            <a class="navbar-brand" href="javascript:void(0)">
                <h4 class="text-success">Dashboard<br> Organizer</h4>
            </a>
        </div>
        <div class="navbar-inner">
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                        ...
                        <div class="nav-link pr-0">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body  ml-3">
                                    ...
                                    <small><span class="mb-0 mt-0 pb-0 pt-0">Organizer</span></small>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/organizer">
                            <i class="ni ni-app text-success"></i>
                            <span class="nav-link-text">Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/organizer/event">
                            <i class="ni ni-air-baloon text-success"></i>
                            <span class="nav-link-text">My Event</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/organizer/ticket">
                            <i class="ni ni-tag text-success"></i>
                            <span class="nav-link-text">Tickets</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/organizer/invoice">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="/organizer/profile">
