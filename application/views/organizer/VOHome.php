                    ...
                    <div class="item">
                        <div class="card card-stats bg-success">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-white mb-0">My Event</h5>
                                        <span class="h2 font-weight-bold text-white mb-0"><?php echo count($myEvent) ?></span>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <a href="organizer/event" class="text-white">
                    ...
                    <div class="item">
                        <div class="card card-stats">
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <a href="organizer/ticket" class="text-default">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h3 font-weight-bold mb-0"><?php echo count($invoice) ?></span>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <a href="organizer/invoice" class="text-default">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h3 font-weight-bold mb-0">Rp <?php echo number_format($revenue[0]->total) ?></span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-green text-white rounded-circle shadow">
                                            <i class="ni ni-chart-bar-32"></i>
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <a class="text-default">
                                        <span class="text-nowrap">From All Event</span>
                                    </a>
                                </p>
                            </div>
                        </div>
                                    ...
                                    <?php foreach ($myEvent as $ev) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <?php if ($ev->status == '1' or $ev->status == '3') { ?>
